...
parser.add_argument('--dataset_name', dest='dataset_name', default='/media/ksc/code/example-data-microtubule-model/', help='name of the dataset')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='../../models/wf-to-generated-sparse/', help='models are saved here')
...
parser.add_argument('--log_dir', default='experiment_model/runs/logs_generated/',
            ...
            for idx in range(0, batch_idxs):
                ...
                for image_path in batch_files:
                    ...
                    with graph.as_default():
                        ...
                        first_save = False
                        sess.close()
    elif args.phase == 'test' and not args.same_input_size:
        tf.reset_default_graph()
        graph = tf.Graph()
        with graph.as_default():
            with tf.Session(graph=graph) as sess:
